...
const routes: Routes = [
  ...
  {
    path: 'dataprivacy',
    loadChildren: () => import('./dataprivacy/dataprivacy.module').then( m => m.DataprivacyPageModule)
  },
  {
    path: 'praticearea',
    loadChildren: () => import('./praticearea/praticearea.module').then( m => m.PraticeareaPageModule)
  },
  {
    path: 'probono',
